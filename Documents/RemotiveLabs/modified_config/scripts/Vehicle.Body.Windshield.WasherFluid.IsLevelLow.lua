local local_signals = {{
    name = "ID321VCFRONT_sensors.VCFRONT_washerFluidLevel",
...
function output_signals()
    return "Vehicle.Body.Windshield.WasherFluid.IsLevelLow"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    if signals["ID321VCFRONT_sensors.VCFRONT_washerFluidLevel"] == 1 then
