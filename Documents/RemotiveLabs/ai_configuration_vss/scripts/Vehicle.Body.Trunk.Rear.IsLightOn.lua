local local_signals = {{
    name = "ID3E3VCRIGHT_lightStatus.VCRIGHT_interiorTrunkLightStatus",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    -- VCRIGHT_interiorTrunkLightStatus 2 "LIGHT_FAULT" 0 "LIGHT_OFF" 1 "LIGHT_ON" 3 "LIGHT_SNA"
    if signals["ID3E3VCRIGHT_lightStatus.VCRIGHT_interiorTrunkLightStatus"] ~= nil then
        if signals["ID3E3VCRIGHT_lightStatus.VCRIGHT_interiorTrunkLightStatus"] == 1 then
