local local_signals = {{
    name = "ID273UI_vehicleControl.UI_frontLeftSeatHeatReq",
...
function output_signals()
    return "Vehicle.Cabin.Seat.Row1.DriverSide.HeatingCooling"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if signals["ID273UI_vehicleControl.UI_frontLeftSeatHeatReq"] ~= nil then
        
        return return_value_or_bytes(math.floor(100*(signals["ID273UI_vehicleControl.UI_frontLeftSeatHeatReq"]/3)))
    end
