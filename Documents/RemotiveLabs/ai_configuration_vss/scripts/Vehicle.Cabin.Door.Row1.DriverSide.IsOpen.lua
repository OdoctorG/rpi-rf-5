local local_signals = {{
    name = "ID102VCLEFT_doorStatus.VCLEFT_frontLatchStatus",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    --VAL_ 259 VCLEFT_rearLatchStatus 5 "LATCH_AJAR" 2 "LATCH_CLOSED" 3 "LATCH_CLOSING" 7 "LATCH_DEFAULT" 8 "LATCH_FAULT" 1 "LATCH_OPENED" 4 "LATCH_OPENING" 0 "LATCH_SNA" 6 "LATCH_TIMEOUT" ;
    if signals["ID102VCLEFT_doorStatus.VCLEFT_frontLatchStatus"] ~= nil then
        if signals["ID102VCLEFT_doorStatus.VCLEFT_frontLatchStatus"] == 1 then
