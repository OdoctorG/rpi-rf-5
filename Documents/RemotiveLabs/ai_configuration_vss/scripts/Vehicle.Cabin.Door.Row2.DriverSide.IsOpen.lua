local local_signals = {{
    name = "ID102VCLEFT_doorStatus.VCLEFT_rearLatchStatus",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if signals["ID102VCLEFT_doorStatus.VCLEFT_rearLatchStatus"] ~= nil then
        if signals["ID102VCLEFT_doorStatus.VCLEFT_rearLatchStatus"] == 1 then
