-- Same as Vehicle.Powertrain.TractionBattery.Range for an EV.
...
function output_signal()
    -- remianing meters
    return "Vehicle.Powertrain.Range"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if (signals["ID33AUI_rangeSOC.UI_Range"] ~= nil) then
        return return_value_or_bytes(signals["ID33AUI_rangeSOC.UI_Range"] * 1609.34)
    else
        return return_nothing()
    end
end
