local local_signals = {{
    name = "ID3F5VCFRONT_lighting.VCFRONT_fogRightStatus",
...
function output_signals()
    return "Vehicle.Body.Lights.Fog.Front.Right.IsOn"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if signals["ID3F5VCFRONT_lighting.VCFRONT_fogRightStatus"] ~= nil then
        if signals["ID3F5VCFRONT_lighting.VCFRONT_fogRightStatus"] == 1 then
