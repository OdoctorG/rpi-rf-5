local local_signals = {{
    name = "ID261_12vBattStatus.v12vBattVoltage261",
...
function output_signal()
    return "Vehicle.LowVoltageBattery.CurrentVoltage"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if (signals["ID261_12vBattStatus.v12vBattVoltage261"] ~= nil and signals["ID261_12vBattStatus.v12vBattVoltage261"] > 5) then
        return return_value_or_bytes(signals["ID261_12vBattStatus.v12vBattVoltage261"])
    else
        return return_nothing()
    end
end
