local local_signals = {{
    name = "ID103VCRIGHT_doorStatus.VCRIGHT_mirrorFoldState",
...
function output_signals()
    return "Vehicle.Body.Mirrors.PassengerSide.IsFolded"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if signals["ID103VCRIGHT_doorStatus.VCRIGHT_mirrorFoldState"] ~= nil then
        if signals["ID103VCRIGHT_doorStatus.VCRIGHT_mirrorFoldState"] == 1 then
