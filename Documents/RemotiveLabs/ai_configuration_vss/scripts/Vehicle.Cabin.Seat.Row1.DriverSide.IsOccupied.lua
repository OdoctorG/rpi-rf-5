local local_signals = {{
    name = "ID3C2VCLEFT_switchStatus.VCLEFT_frontOccupancySwitch",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    -- VCLEFT_frontOccupancySwitch 3 "SWITCH_FAULT" 1 "SWITCH_OFF" 2 "SWITCH_ON" 0 "SWITCH_SNA" ;
    if signals["ID3C2VCLEFT_switchStatus.VCLEFT_frontOccupancySwitch"] ~= nil then
        if return_value_or_bytes(signals["ID3C2VCLEFT_switchStatus.VCLEFT_frontOccupancySwitch"]) == 2 then
