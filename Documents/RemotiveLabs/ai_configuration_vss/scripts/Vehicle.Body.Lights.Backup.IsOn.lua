...
function output_signals()
    return "Vehicle.Body.Lights.Backup.IsOn"
end
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    -- VCRIGHT_reverseLightStatus 2 "LIGHT_FAULT" 0 "LIGHT_OFF" 1 "LIGHT_ON" 3 "LIGHT_SNA"
    if signals["ID3E3VCRIGHT_lightStatus.VCRIGHT_reverseLightStatus"] ~= nil then
        if signals["ID3E3VCRIGHT_lightStatus.VCRIGHT_reverseLightStatus"] == 1 then
