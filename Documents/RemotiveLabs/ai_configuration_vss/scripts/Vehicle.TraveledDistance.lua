...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    -- Odometer3B6 : 0|32@1+ (0.001,0) [0|4294970] "KM"  Receiver
    -- Odometer3B6 4294967 "SNA" ;
    -- Check that signal is available
    if (signals["ID3B6odometer.Odometer3B6"] ~= nil and signals["ID3B6odometer.Odometer3B6"] < 4294967) then
