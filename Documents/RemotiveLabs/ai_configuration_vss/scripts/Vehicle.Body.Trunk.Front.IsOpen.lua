local local_signals = {{
    name = "ID2E1VCFRONT_status.VCFRONT_frunkLatchStatus",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    -- VCRIGHT_trunkLatchStatus 5 "LATCH_AJAR" 2 "LATCH_CLOSED" 3 "LATCH_CLOSING" 7 "LATCH_DEFAULT" 8 "LATCH_FAULT" 1 "LATCH_OPENED" 4 "LATCH_OPENING" 0 "LATCH_SNA" 6 "LATCH_TIMEOUT" ;
    if signals["ID2E1VCFRONT_status.VCFRONT_frunkLatchStatus"] ~= nil then
        if signals["ID2E1VCFRONT_status.VCFRONT_frunkLatchStatus"] == 1 then
