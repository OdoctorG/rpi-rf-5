local local_signals = {{
    name = "ID103VCRIGHT_doorStatus.VCRIGHT_rearLatchStatus",
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    ...
    if signals["ID103VCRIGHT_doorStatus.VCRIGHT_rearLatchStatus"] ~= nil then
        if signals["ID103VCRIGHT_doorStatus.VCRIGHT_rearLatchStatus"] == 1 then
