local local_signals = {{
    name = "APIMGPS_Data_Nav_1.GPS_Latitude_Degrees",
    namespace = "HS3"
}, {
    name = "APIMGPS_Data_Nav_1.GPS_Latitude_Minutes",
    namespace = "HS3"
}, {
    name = "APIMGPS_Data_Nav_1.GPS_Latitude_Min_dec",
    namespace = "HS3"
}}
...
function signals(signals, namespace, signals_timestamp_us, system_timestamp_us)
    if (signals["APIMGPS_Data_Nav_1.GPS_Latitude_Degrees"] < 0) then
        return return_value_or_bytes(signals["APIMGPS_Data_Nav_1.GPS_Latitude_Degrees"] -
                                        signals["APIMGPS_Data_Nav_1.GPS_Latitude_Minutes"] / 60 -
                                        signals["APIMGPS_Data_Nav_1.GPS_Latitude_Min_dec"] / 60)
    else
        return return_value_or_bytes(signals["APIMGPS_Data_Nav_1.GPS_Latitude_Degrees"] +
                                        signals["APIMGPS_Data_Nav_1.GPS_Latitude_Minutes"] / 60 +
                                        signals["APIMGPS_Data_Nav_1.GPS_Latitude_Min_dec"] / 60)
